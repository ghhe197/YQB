...
//            labelView.font = titleFont;
            ...
            labelView.font = [UIFont fontWithName:@"FZLTHJW--GB1-0" size:16];
...
- (void)show
{
    ...
    for (NSUInteger i = 0; i < _blocks.count; i++)
    {
        ...
        button.frame = CGRectMake(xOffset, _height + 8, width, kAlertButtonHeight);
//        button.titleLabel.font = buttonFont;
        button.titleLabel.font = [UIFont fontWithName:@"FZLTHJW--GB1-0" size:16];
